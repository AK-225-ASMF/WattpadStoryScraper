...
def main():
    ...
    for listOfLinks in links:
        ...
        # Print out and flush the number of the chapter you just wrote
        print(chapNumber, end=", ")
        sys.stdout.flush()
